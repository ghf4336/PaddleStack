...
function EndSessionModal({ open, onClose, onConfirm, sessionPlayers, deletedPlayers = [], uploadedPlayers = [] }) {
  ...
  function handleDownload() {
    // Generate the download content using the utility function
    const text = generatePlayerDownloadData(sessionPlayers, deletedPlayers, uploadedPlayers);

    if (!text) return; // No players to download
